        ...
        series: [
          {
            name: 'Notes',
            data: [
              $(element).attr("data-rate-global"),
              $(element).attr("data-rate-client"),
              $(element).attr("data-rate-functionality"),
              $(element).attr("data-rate-price"),
              $(element).attr("data-rate-interface")
            ]
          }
        ],
  ...
  if (ratings.length) {
    ratings.each(function () {
      $(this).rateYo({
        rating: 3.6,
        rtl: isRtl,
        starWidth:$(this).attr("starWidth")??"20px",
        ...
        console.log($(this).attr("starWidth"));
